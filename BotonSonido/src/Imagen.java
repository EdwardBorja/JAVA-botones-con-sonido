...
public class Imagen extends javax.swing.JFrame {
    ...
    public Imagen() {
        initComponents();
         ImageIcon img = new ImageIcon("C:\\Users\\edward\\Desktop\\Evidencia.jpg");
         jLabel1.setIcon(new ImageIcon(img.getImage().getScaledInstance(353, 243,Image.SCALE_SMOOTH)));
    }
